...
#
# This is meant to run whenever the upstream endpoint rules or partitions change:
# regenerate, then commit the updated .c files so the change ships with the next
# build. Fetching the upstream defaults requires network access.
